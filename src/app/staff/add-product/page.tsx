...
export default function AddProductPage() {
  const [product, setProduct] = useState({
    name: '', description: '', price: '', stockQuantity: '', category: '', brand: '', warranty: null
  });
  ...
  const handleWarrantyChange = (date: Date | null) => {
    setProduct({ ...product, warranty: date });
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const warrantyDate = product.warranty ? new Date(product.warranty) : null;
    const currentDate = new Date();
    if (product.warranty && warrantyDate && warrantyDate <= currentDate) {
      setError('Ngày bảo hành phải là ngày trong tương lai!');
      return;
    }
    ...
    try {
      ...
      const res = await fetch('/api/product/add', {
        ...
        body: JSON.stringify({
          ...
          product: {
            ...
            warranty: product.warranty ? product.warranty.toISOString() : undefined,
          },
      ...
      if (data.success) {
        ...
        setProduct({ name: '', description: '', price: '', stockQuantity: '', category: '', brand: '', warranty: null });
